...
class CalculateInvestmentEstimateController extends BaseApiController implements ControllerInterface
{
    ...
    public function execute(array $params): mixed
    {
        try {
            ...
            $result = $this->calculateUseCase->recalculate($input);

            $this->jsonResponse(200, $this->buildPayload($input, $result));
